...
export const metadata = {
    title: 'Pre-Conference Workshops | IAPSMGC CON 2026',
    description: 'Pre-Conference Workshops for IAPSMGC CON 2026 at PIMSR, Parul University, Vadodara.',
};
...
const workshops = [
    {
        ...
        title: 'Advanced Data Analysis using IBM SPSS Statistics / R',
        color: '#D4AF37',
    ...
    },
    {
        id: 'D',
        icon: <Globe size={26} />,
        title: 'GIS Mapping for Epidemiological Surveillance',
        color: '#D4AF37',
            ...
            <div className="program-hero">
                <div className="container" style={{ paddingTop: '120px', paddingBottom: '4rem' }}>
                    ...
                    <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '1.1rem', maxWidth: '600px', lineHeight: 1.6 }}>
                        Join us on November 26, 2026 for intensive, skill-building workshops led by domain experts. Enhance your expertise before the main conference begins.
                    </p>
